...
Program Name           : qtcb_vs_serum_1.sas 

Path                   : sg1\049_qtcb_vs_serum
...
---     ----    -------         --------        ---------------------------------------------------
001     1.00    5/15/26        dgianneschi     Create.
*********************************************************************************************/
...
*-------------------------------------------------------------------------------------
 ...
 -------------------------------------------------------------------------------------;
title1 " Figure 14.1.1. QTcB Interval by AVDXXX Serum Concentration" ;
...
proc sgplot data=labs cycleattrs;
  refline 475 500 /transparency=0.8	;
  scatter y=value x=concentration/group=trt ;
  xaxis type=log minor label="AVDXXX Concentration (ng/mL)";
  yaxis label="QTcB Interval (msec)" values=(200 to 600 by 50);
