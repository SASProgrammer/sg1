...
Program Name           : lab_data_with_subject_in_plotarea_1.sas

Path                   : sg1\012_Lab_Data_with_subject_number_plotarea
...
libname Dir_ '.';
 ...
 %let Program_  = lab_data_with_subject_in_plotarea_1;
