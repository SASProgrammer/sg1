"""
build_data.py  --  Example 007: Mean panels with consistent Y-axis scale
Generates longitudinal lab data with 3 lab tests × 3 treatments.
"""
...
# Lab-specific baseline and drug-effect trajectories
lab_config = {
    "Hemoglobin": {
...
print(f"Generated {len(df)} rows for {df['labtest'].nunique()} lab tests.")
