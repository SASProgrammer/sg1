"""build_data.py -- Example 034: Scatter panels, consistent Y. Same data as 032."""
import numpy as np, pandas as pd
rng=np.random.default_rng(seed=34); N_SUBJ=60; TRTS=["Placebo","Drug A 10mg","Drug A 25mg"]; PANELS=["Visit 1","Visit 2","Visit 3"]
