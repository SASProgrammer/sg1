...
Program Name           : scatter_panel_X_consistent_landscape_linear_1.sas  

Path                   : sg1/032_scatter_panel_X_consistent_landscape_linear

Purpose                : To demonstrate creation of a scatter panel X consistent linear with landscape layout
...
*-------------------------------------------------------------------------------------
 ...
 %let Program_  = scatter_panel_X_consistent_landscape_linear_1;
 ...
 *-----------------------------------------------------------------------------------  
  ...
  -----------------------------------------------------------------------------------*;
   %macro titles(pdf=Y);
      ...
      title4 "Multi-Panel With Consistent X axis";
      %if %upcase(&pdf)=Y %then %do; 
          footnote1 j=l "_________________________________________________________________"
                        "________________________________________________________________________";
       %end;
       %else %do; 
          footnote1 j=l "_________________________________________________________________________"
