...
*-----------------------------------------------------------------------------------
 ...
 %macro loop;
   ...
   proc sgplot data=labs noautolegend;
      ...
      *min=-2 max=10 values=(-2 0 2 4 6 8 10);
   run;
%mend loop;
...
*----------------------------------------------------------------------------------  
 ...
 ods listing  close;                        * Output SGE files;
